...
define('skylark-jsbin-processors/jsbin',[
  "skylark-jsbin-base"
],function(jsbin){
  return jsbin;
});
...
define('skylark-jsbin-processors/processors',[
  ...
  var processors = {
    ...
    scss: createProcessor({
      ...
      handler: jsbin.throttle(jsbin.debounceAsync(function sass(source, resolve, reject, done) {
        $.ajax({
          type: 'post',
          url: '/processor',
          data: {
    ...
    sass: createProcessor({
      ...
      handler: jsbin.throttle(jsbin.debounceAsync(function (source, resolve, reject, done) {
        $.ajax({
          type: 'post',
          url: '/processor',
          data: {
...
//# sourceMappingURL=sourcemaps/skylark-jsbin-processors.js.map
